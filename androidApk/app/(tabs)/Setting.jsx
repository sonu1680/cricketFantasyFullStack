  ...
  return (
    <SafeAreaView className="bg-white">
      ...
      <ScrollView className="p-4">
        {userProfile != null ? (
          ...
          <View className="items-center mb-6">
            <Image
              ...
              className="w-32 h-32 rounded-full"
            />
            <Text className="text-lg font-bold mt-2">My Name</Text>
            <Text className="text-sm text-gray-500">My EmailId</Text>
          </View>
        )}
        ...
        <TouchableOpacity
          onPress={() => router.push("/settingPages/Security")}
          className="flex-row items-center justify-between py-3 border-b border-gray-200"
        >
          <View className="flex-row items-center">
        ...
        <TouchableOpacity
          onPress={() => router.push("/AllTransactionPage")}
          className="flex-row items-center justify-between py-3 border-b border-gray-200"
        >
          <View className="flex-row items-center">
        ...
        <TouchableOpacity
          onPress={() => router.push("/(tabs)/MyContest")}
          className="flex-row items-center justify-between py-3 border-b border-gray-200"
        >
          <View className="flex-row items-center">
        ...
        <TouchableOpacity
          onPress={() => router.push("/settingPages/Support")}
          className="flex-row items-center justify-between py-3 border-b border-gray-200"
        >
          <View className="flex-row items-center">
